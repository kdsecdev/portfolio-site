  ...
  return (
    <SectionWrapper id="work">
      ...
      <a
        ...
        className="group flex flex-col sm:flex-row items-center gap-5 sm:gap-8 mb-10 sm:mb-14 p-5 sm:p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-[#00FF85]/40 hover:bg-[#00FF85]/[0.03] transition-all duration-300"
      >
        {/* GitHub wordmark + avatar */}
        <div className="flex items-center gap-3 shrink-0">
          <div className="w-12 h-12 rounded-xl bg-white/8 border border-white/10 flex items-center justify-center group-hover:border-[#00FF85]/30 transition-colors">
            <svg viewBox="0 0 16 16" className="w-6 h-6 fill-white/80 group-hover:fill-white transition-colors" aria-hidden="true">
              <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
            </svg>
          </div>
          <div>
            <p className="font-bold text-white text-sm group-hover:text-[#00FF85] transition-colors">github.com/kdsecdev</p>
            <p className="text-xs text-white/40 font-mono mt-0.5">Real commits. Real code.</p>
          </div>
        </div>
        ...
        <div className="flex-1 w-full overflow-hidden rounded-lg opacity-70 group-hover:opacity-100 transition-opacity min-w-0">
          <img
            src="https://ghchart.rshah.org/00FF85/kdsecdev"
        ...
        {/* CTA arrow */}
        <div className="shrink-0 flex items-center gap-1.5 text-white/40 group-hover:text-[#00FF85] transition-colors text-sm font-semibold">
